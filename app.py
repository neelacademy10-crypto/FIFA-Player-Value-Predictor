...
with col_chart:
    if os.path.exists("visuals/08_model_comparison.png"):
        st.image("visuals/08_model_comparison.png", use_container_width=True)
    else:
        st.info("Run fifa_analysis.py to generate model comparison chart")
...
with c1:
    ...
    if os.path.exists("visuals/04_overall_vs_value.png"):
        st.image("visuals/04_overall_vs_value.png", use_container_width=True)
...
with c2:
    ...
    if os.path.exists("visuals/03_correlation_heatmap.png"):
        st.image("visuals/03_correlation_heatmap.png", use_container_width=True)
...
with c3:
    ...
    if os.path.exists("visuals/09_actual_vs_predicted.png"):
        st.image("visuals/09_actual_vs_predicted.png", use_container_width=True)
...
with c4:
    ...
    if os.path.exists("visuals/10_feature_importance.png"):
        st.image("visuals/10_feature_importance.png", use_container_width=True)
